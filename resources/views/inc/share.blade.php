    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="whatsapp://send?text=my digital bisiness card link {{urlencode($url)}}" class="d-xl-none" data-action="share/whatsapp/share"><i class="icon-whatsapp"> Whatsapp</i></a>
            </div>
        </div>
    </div>
</div>
