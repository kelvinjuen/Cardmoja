...
<div class="site-section">
        <div class="container">
            <div class="card-wrap ">
                <h3 class="text-secondary mb-2 text-center">Coperate Card Details</h3>
                <form id="coperate_form">
...
<script type="text/javascript" language="javascript">
    ...
    $(document).on('submit', '#coperate_form', function(event){
        event.preventDefault();
        var success = false;

        $.ajax({
            url:"{{route('coperate.store')}}",
            method:'POST',
            async: false,
            ...
            success:function(data)
            {
                var obj = data.errors;
                if(obj != null){
                    $('#email_1').attr('placeholder',obj['firstName']);
                }else{
